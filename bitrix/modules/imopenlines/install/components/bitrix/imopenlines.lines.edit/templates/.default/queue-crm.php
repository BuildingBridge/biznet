		...
		<div class="imopenlines-form-settings-inner">
			...
			<div class="imopenlines-control-checkbox-container">
				<label class="imopenlines-control-checkbox-label">
					...
					<?=Loc::getMessage("IMOL_CONFIG_EDIT_TIMEMAN")?>
					<span data-hint="<?=htmlspecialcharsbx(Loc::getMessage('IMOL_CONFIG_EDIT_TIMEMAN_DESCRIPTION_NEW'))?>"></span>
				</label>
			</div>
			<?
			if (!IsModuleInstalled("timeman"))
			{
				...
				<script type="text/javascript">
					BX.bind(BX('imol_timeman'), 'change', function(e){
						...
						alert('<?=GetMessageJS(!IsModuleInstalled("bitrix24")? "IMOL_CONFIG_EDIT_TIMEMAN_SUPPORT_B24_NEW": "IMOL_CONFIG_EDIT_TIMEMAN_SUPPORT_CP")?>');
					});
				</script>
				<?
			}
			...
			<div id="imol_check_offline_block" class="imopenlines-control-checkbox-container<?if ($arResult['VISIBLE']['CHECK_OFFLINE_BLOCK'] == false){?> invisible<?}?>">
				<label class="imopenlines-control-checkbox-label">
					...
					<?=Loc::getMessage("IMOL_CONFIG_EDIT_CHECKING_OPERATOR_OFFLINE")?>
					<span data-hint="<?=htmlspecialcharsbx(Loc::getMessage('IMOL_CONFIG_EDIT_CHECKING_OPERATOR_OFFLINE_DESC_NEW'))?>"></span>
				</label>
			</div>
			...
			<div class="imopenlines-form-settings-inner">
				<div class="imopenlines-control-subtitle">
					<?=Loc::getMessage('IMOL_CONFIG_EDIT_MIN_DAYS_TO_CHECK_DIALOGS_TITLE')?>
					<span data-hint="<?=htmlspecialcharsbx(Loc::getMessage('IMOL_CONFIG_EDIT_MIN_DAYS_TO_CHECK_DIALOGS_TIP'))?>"></span>
				</div>
				<div class="imopenlines-control-inner width-80">
					<input type="text"
						   class="imopenlines-control-input"
						   name="CONFIG[MIN_DAYS_TO_CHECK_DIALOGS]"
						   value="<?=htmlspecialcharsbx($arResult['CONFIG']['MIN_DAYS_TO_CHECK_DIALOGS'])?>">
				</div>
			</div>
			<?
			if(defined('IMOL_FDC'))
