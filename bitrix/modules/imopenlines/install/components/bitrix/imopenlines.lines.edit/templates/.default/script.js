	...
	window.BX.OpenLinesConfigEdit = {
		...
		changeQueueTypeValue: function(selector)
		{
			if (selector.options[selector.selectedIndex].value == 'all')
			{
				...
				BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_online_block'), false);
				BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_offline_block'), true);
			}
			else
			{
				...
				if(BX.hasClass(BX('imol_check_online_block'), 'invisible'))
				{
					BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_online_block'), true);

					if(BX('imol_check_online').checked == true)
					{
						BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_offline_block'), true);
					}
					else
					{
						BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_offline_block'), false);
						BX('imol_checking_offline').checked=false;
					}
				}
			}
		},
		...
		{
			BX.animationHandler.fadeSlideToggleByClass(BX('imol_check_offline_block'));
			BX('imol_checking_offline').checked=false;
		},
