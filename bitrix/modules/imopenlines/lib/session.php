...
class Session
{
	...
	public function checkOperatorWorkTime()
	{
		...
		Debug::addSession($this,  __METHOD__, ['result' => $result, 'TIMEMAN_ENABLE' => $this->config['TIMEMAN'], 'OPERATOR_ID' => $this->session['OPERATOR_ID'], 'isRealOperator' => Queue::isRealOperator($this->session['OPERATOR_ID']), 'ActiveStatusByTimeman' => Queue::getActiveStatusByTimeman($this->session['OPERATOR_ID'], true)]);
