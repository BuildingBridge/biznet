...
class Config
{
	...
	private function prepareFields($params, $mode = self::MODE_ADD)
	{
		...
		if (isset($params['MIN_DAYS_TO_CHECK_DIALOGS']))
		{
			$fields['MIN_DAYS_TO_CHECK_DIALOGS'] = intval($params['MIN_DAYS_TO_CHECK_DIALOGS']) > 1 ? intval($params['MIN_DAYS_TO_CHECK_DIALOGS']) : 1;
		}
		else if ($mode == self::MODE_ADD)
		{
			$fields['MIN_DAYS_TO_CHECK_DIALOGS'] = 1;
		}
