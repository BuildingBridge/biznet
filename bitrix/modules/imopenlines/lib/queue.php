...
class Queue
{
	...
	const REASON_OPERATOR_DAY_PAUSE = 'REMOVING';
	const REASON_OPERATOR_DAY_END = 'REMOVING';
	 ...
	 * @return bool
	 */
	public static function isOperatorActive($userId, $isTimeMan = 'N')
	{
		$result = true;
		...
		if ($result  && $isTimeMan == "Y" && !self::getActiveStatusByTimeman($userId))
		{
			$result = false;
		}
