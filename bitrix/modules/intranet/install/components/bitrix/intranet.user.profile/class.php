...
class CIntranetUserProfileComponent extends UserProfile
{
	...
	public function executeComponent()
	{
		...
		$this->arResult["EnableUserFieldCreation"] = (
			$this->arResult["EnableCommonConfigurationUpdate"]
			&& $this->arResult["AllowAllUserProfileFields"]
		);
		...
		{
			$this->arResult["FormFields"] = $this->getFormInstance()->getFieldInfo($this->arResult["User"], $this->arResult["UserFieldsAvailable"]);
		}
