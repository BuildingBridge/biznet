...
//							BX.UserContentView.currentPopupId = null;
				...
				BX.bind(BX('tags-users-popup-' + this.checksum), 'mouseout' , function() {
				...
				BX.bind(BX('tags-users-popup-' + this.checksum), 'mouseover' , function() {
					clearTimeout(this.hidePopupTimeoutId);
					clearTimeout(this.leavePopupTimeoutId);
				}.bind(this));

				BX.bind(params.bindNode, 'mouseleave' , BX.delegate(function() {
					this.leavePopupTimeoutId = setTimeout(BX.delegate(function() {
						this.popup.close();
					}, this), 1000);
				}, this));
			}
