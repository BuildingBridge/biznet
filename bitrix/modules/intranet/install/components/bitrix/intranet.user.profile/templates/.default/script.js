;(function ()
{
	...
	namespace.Manager.prototype = {
		...
		showActionPopup: function(bindElement)
		{
			...
			if ((this.userStatus === "admin" || this.userStatus === "integrator") && this.canEditProfile)
			{
			...
			if (this.userStatus === "fired" && this.canEditProfile && !this.isOwnProfile && !this.isCurrentUserIntegrator)
			{
				menuItems.push({
