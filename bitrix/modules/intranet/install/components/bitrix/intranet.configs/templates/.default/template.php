	...
	<!-- webdav/disk-->
		...
		<tr>
			<td class="content-edit-form-field-name content-edit-form-field-name-left">
				...
				<?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_version_limit_per_file")):?>
					<?
			...
			<td class="content-edit-form-field-input">
				<select name="disk_version_limit_per_file" <?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_version_limit_per_file")) echo "disabled";?>>
		...
		<tr>
			<td class="content-edit-form-field-name content-edit-form-field-name-left">
				...
				<?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_file_sharing")):?>
					<?
			...
			<td class="content-edit-form-field-input">
				<input type="checkbox"
					<?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_file_sharing")) echo "disabled";?>
					id="disk_allow_use_external_link"
					name="disk_allow_use_external_link"
					<?if (COption::GetOptionString("disk", "disk_allow_use_external_link", "Y") == "Y"):?>checked<?endif?>
		...
		<tr>
			<td class="content-edit-form-field-name content-edit-form-field-name-left">
				...
				<?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_object_lock_enabled")):?>
					<?
			...
			<td class="content-edit-form-field-input">
				<input type="checkbox" <?if ($arResult["IS_BITRIX24"] && !\Bitrix\Bitrix24\Feature::isFeatureEnabled("disk_object_lock_enabled")) echo "disabled";?> id="disk_object_lock_enabled" name="disk_object_lock_enabled" <?if (COption::GetOptionString("disk", "disk_object_lock_enabled", "N") == "Y"):?>checked<?endif?> class="content-edit-form-field-input-selector"/>
			</td>
			<td class="content-edit-form-field-error"></td>
		</tr>
...
<!-- logo -->
<?
if ($arResult["IS_BITRIX24"] && \Bitrix\Bitrix24\Feature::isFeatureEnabled("set_logo") || !$arResult["IS_BITRIX24"])
{
