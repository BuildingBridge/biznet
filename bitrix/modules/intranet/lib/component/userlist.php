...
//		$path = (isset($params['PATH']) ? $params['PATH'] : '');
	...
	public function getUserPropertyList()
	{
		...
		{
			$result = \Bitrix\Intranet\Component\UserList::getUserPropertyListDefault();
		}
	...
	{
		$optionValue = \Bitrix\Intranet\Component\UserList::getUserPropertyListValue();
