...
final class ClearUnregisteredLogo extends AgentBase
{
	...
	public static function doRun()
	{
		...
		{
			$startTime = START_EXEC_TIME * 1000;
		}
		else
		{
		...
		$result = $connection->query("
			...
			where 
				...
				and id not in (select  
							...
							from (
								select 1 as n union
								select 2 union select 3 union select 4 union select 5 union
								select 6 union select 7 union select 8 union select 9 union
								select 10 union select 11 union select 12 union select 13 union
								select 14 union select 15 union select 16 union select 17 union
