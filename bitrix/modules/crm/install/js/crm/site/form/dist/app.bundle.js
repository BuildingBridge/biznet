(function (exports) {
    ...
    var MixinString = {
      props: ['field', 'itemIndex', 'item', 'readonly'],
      mixins: [MixinField],
      computed: {
    ...
    var ScrollDown = {
      ...
      methods: {
        scrollDown: function scrollDown() {
          ...
          var interval = 10;
          var duration = 100;
          var diff = el.scrollHeight - el.offsetHeight - el.scrollTop;
        ...
        handleResize: function handleResize() {
          var el = this.$el.previousElementSibling;
          var visible = el.scrollHeight - el.clientHeight > 10;
    ...
    var windowMixin = {
      ...
      methods: {
        ...
        toggleScroll: function toggleScroll() {
          ...
          Scroll.toggle(this.$el.querySelector('.b24-window-scrollable'), !this.show);
        }
      },
      mounted: function mounted() {
        this.listenEsc();
