		...
		renderDescription: function()
		{
			...
			this.elements.scoringTextBlock = BX.create("div", {
				...
				children: [
					BX.create("div", {
						...
						text: BX.message("CRM_ML_SCORING_DESCRIPTION_TITLE")
					}),
			...
			if(this.state == ViewState.Idle)
			{
				...
				this.elements.scoringDescBlock.appendChild(
					BX.create("div", {
						props: {className: "crm-ml-entity-content-desc"},
						text: BX.message("CRM_ML_SCORING_DESCRIPTION_P2")
					})
				);
					...
					switch (this.trainingError.code)
					{
						...
						case TrainingError.TooSoon:
							this.elements.scoringDescBlock.appendChild(
								BX.create("div", {
									props: {className: "crm-ml-entity-content-desc"},
									text: BX.message("CRM_ML_SCORING_ERROR_TOO_SOON").replace("#DATE#", this.currentTraining["NEXT_DATE"])
								})
							);
					}
