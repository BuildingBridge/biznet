...
<script>
	BX.message({
		...
		"CRM_ML_SCORING_ERROR_TOO_SOON": '<?= GetMessageJS("CRM_ML_SCORING_ERROR_TOO_SOON")?>',
		...
		"CRM_ML_SCORING_DESCRIPTION_TITLE": '<?= GetMessageJS("CRM_ML_SCORING_DESCRIPTION_TITLE")?>',
		"CRM_ML_SCORING_DESCRIPTION_P1": '<?= GetMessageJS("CRM_ML_SCORING_DESCRIPTION_P1")?>',
		"CRM_ML_SCORING_DESCRIPTION_P2": '<?= GetMessageJS("CRM_ML_SCORING_DESCRIPTION_P2")?>',
