...
<div class="crm-analytics-source-block crm-analytics-source-block-desc">
	...
	<form method="post" id="crm-tracking-settings">
		...
		<div class="crm-analytics-source-section">
			<div class="ui-title-3 ui-mb-15"><?=Loc::getMessage('CRM_TRACKING_SETTINGS_ATTR_WINDOW')?></div>
			<div class="crm-analytics-source-desc">
				<div class="ui-ctl ui-ctl-inline">
					<span class="ui-ctl-label-text ui-pb-0"><?=Loc::getMessage('CRM_TRACKING_SETTINGS_ATTR_WINDOW_SITE')?></span>
				</div>
				...
				<div class="ui-ctl ui-ctl-inline ui-ctl-row">
					<span class="ui-ctl-label-text ui-pb-0">
						<?=Loc::getMessage('CRM_TRACKING_SETTINGS_ATTR_WINDOW_DAYS')?>
					</span>
					<span class="ui-hint ui-mv-0 ui-ml-5" data-hint="<?=Loc::getMessage('CRM_TRACKING_SETTINGS_ATTR_WINDOW_SITE_HINT')?>"></span>
				</div>
				...
				<label class="ui-ctl ui-ctl-checkbox ui-ctl-w100">
					...
					<span class="ui-hint ui-mv-0" data-hint="<?=Loc::getMessage('CRM_TRACKING_SETTINGS_ATTR_WINDOW_OFFLINE_HINT')?>"></span>
				</label>
			</div>

			<br><br>
			<div class="ui-title-3 ui-mb-10">
