...
//				array('id' => 'DELIVERY_ID', 'name' => Loc::getMessage('CRM_COLUMN_DELIVERY_ID'), 'sort' => 'DELIVERY_ID', 'editable' => false),
	...
	public function executeComponent()
	{
		...
		if (isset($glFilter['CLIENT.ENTITY_TYPE_ID']) || isset($glFilter['CLIENT']))
		{
			if(isset($glFilter['CLIENT']))
			{
				$glFilter[] = $glFilter['CLIENT'];
				unset($glFilter['CLIENT']);
			}
			$runtime[] =
		...
		if(isset($glFilter['ORDER_DEAL.DEAL_ID']))
		{
			$runtime[] =
				new Main\ORM\Fields\Relations\Reference('ORDER_DEAL',
