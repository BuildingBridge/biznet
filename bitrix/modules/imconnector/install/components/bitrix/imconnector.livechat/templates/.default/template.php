		...
		<div class="imconnector-field-container">
			<div class="imconnector-field-section">
				<div class="imconnector-step-text imconnector-livechat-inner-container" style="padding-top: 0;">
					...
					<div id="imconnector-livechat-open-phrases" class="imconnector-livechat-public-link-settings-inner imconnector-livechat-no-padding<?=empty($arResult['OPEN_BLOCK_PHRASES'])?'':' imconnector-livechat-public-open';?>">
						<div class="imconnector-livechat-public-link-settings-inner-settings-container">
