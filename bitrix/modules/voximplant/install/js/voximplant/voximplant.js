            ...
            return function (target, key, _value) {
                return {
                    value: function value() {
                        ...
                        try {
                            //exception for login mascaraed
                            if (key === 'login' || key === "basicLogin" || key === 'callRemoteFunction' && args[0] === 'login') {
                                var maskingIdx = 1;
                                if (key === 'callRemoteFunction') maskingIdx = 2;
                                a = args.map(function (a, key) {
                                    if (key === maskingIdx) return '"********"';
                        ...
                        var className = '';
                        if (target._traceName) {
                            className = target._traceName();
                            if (this && this.settings) {
                                className += ' ' + this.settings.id;
                            } else if (this && this.id && typeof this.id !== 'function') {
                                className += ' ' + this.id;
                            }
                        }
...
var ZingayaAPI_1 = __webpack_require__(56);
var PushService_1 = __webpack_require__(57);
    ...
    _createClass(Client, [{
        ...
        value: function init(config) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (window.location.hostname != '127.0.0.1' && window.location.hostname != 'localhost' && window.location.protocol != 'https:') {
                    if (typeof console.error != 'undefined' && _this2.showWarnings) console.error("WARNING: getUserMedia() is deprecated on insecure origins, and support will be removed in the future. You should consider switching your application to a secure origin, such as HTTPS. See https://goo.gl/rStTGz for more details.");
                }
        ...
        value: function setOperatorACDStatus(status) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this4.voxSignaling.callRemoteFunction(RemoteFunction_1.RemoteFunction.setOperatorACDStatus, status, new GUID_1.GUID().toString());
                resolve();
            });
        }
        /**
        ...
        value: function getOperatorACDStatus() {
            ...
            return new Promise(function (resolve, reject) {
                Utils_1.Utils.checkCA();
                _this5.voxSignaling.callRemoteFunction(RemoteFunction_1.RemoteFunction.getOperatorACDStatus, new GUID_1.GUID().toString());
...
var RemoteFunction_1 = __webpack_require__(3);
var RemoteEvent_1 = __webpack_require__(12);
var MsgSignaling_1 = __webpack_require__(17);
    ...
    _createClass(VoxSignaling, [{
        ...
        value: function callRemoteFunction(name) {
            ...
            if (typeof this.ws != "undefined") {
                ...
                this.ws.send(data);
                if (name !== RemoteFunction_1.RemoteFunction.login) Logger_1.LogManager.get().writeMessage(Logger_1.LogCategory.SIGNALING, '[wsdataout]', Logger_1.LogLevel.INFO, data);else {
                    params[1] = '********';
                    Logger_1.LogManager.get().writeMessage(Logger_1.LogCategory.SIGNALING, '[wsdataout]', Logger_1.LogLevel.INFO, JSON.stringify({ "name": name, "params": params }));
                }
                return true;
            }
        }
...
var CallExServer_1 = __webpack_require__(49);
var RemoteFunction_1 = __webpack_require__(3);
var RemoteEvent_1 = __webpack_require__(12);
var CallExMedia_1 = __webpack_require__(50);
var CallstatsIo_1 = __webpack_require__(16);
var CodecSorterHelpers_1 = __webpack_require__(51);
var SDPMuggle_1 = __webpack_require__(15);
    ...
    _createClass(CallManager, [{
        ...
        value: function findCall(id, functionName) {
            ...
            if (typeof c == 'undefined') {
                if (functionName !== 'onICEResult') this.log.warning('Received ' + functionName + ' for unknown call ' + id);
                return null;
            }
            return c;
        }
        ...
        value: function handleConnectionDisconnected(id, headers, params) {
            ...
            c.onDisconnected(headers, params).then(function () {
                delete _this7._calls[id];
            }).catch(function (e) {
                _this7.log.error("Can't remove the call " + id + ": " + e.message);
            });
        }
    }, {
        key: "handleSIPInfo",
...
var Client_1 = __webpack_require__(1);
var Bowser = __webpack_require__(54);
var TransreceiverPC_1 = __webpack_require__(55);
/**
...
(function (BrowserSpecific) {
    ...
    function peerConnectionFactory(id, mode, videoEnabled, iceServers) {
        Logger_1.LogManager.get().writeMessage(Logger_1.LogCategory.RTC, "Core", Logger_1.LogLevel.TRACE, "Create WebRTC on the " + JSON.stringify(browser));
        switch (vendor) {
            case Vendor.Firefox:
...
Object.defineProperty(exports, "__esModule", { value: true });
var Logger_1 = __webpack_require__(0);
var MsgEnums_1 = __webpack_require__(18);
var VoxSignaling_1 = __webpack_require__(2);
var EventTarget_1 = __webpack_require__(14);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var Implement = __webpack_require__(70);
/**
...
var Constants_1 = __webpack_require__(10);
var RemoteFunction_1 = __webpack_require__(3);
var ReInviteQ_1 = __webpack_require__(28);
var Client_1 = __webpack_require__(1);
var index_1 = __webpack_require__(4);
/**
 * @hidden
...
var Logger_1 = __webpack_require__(0);
var PCFactory_1 = __webpack_require__(8);
var TransceiversEndpointManager_1 = __webpack_require__(47);
var PlainEndpointManager_1 = __webpack_require__(48);
/**
 * @hidden
 */
...
var Message = function () {
    ...
    function Message(message, payload) {
        ...
        this._text = message;
        if (typeof payload !== 'undefined') this._payload = payload;else this._payload = [];
...
Object.defineProperty(exports, "__esModule", { value: true });
var Logger_1 = __webpack_require__(0);
var Endpoint_1 = __webpack_require__(37);
var MediaRenderer_1 = __webpack_require__(35);
...
var Messenger_1 = __webpack_require__(19);
...
var CallManager_1 = __webpack_require__(5);
var RemoteFunction_1 = __webpack_require__(3);
var CodecSorter_1 = __webpack_require__(38);
var CallEvents_1 = __webpack_require__(6);
var CallstatsIo_1 = __webpack_require__(16);
var Constants_1 = __webpack_require__(10);
var SDPMuggle_1 = __webpack_require__(15);
    ...
    _createClass(WebRTCPC, [{
        ...
        value: function getPCStats() {
            ...
            BrowserSpecific_1.default.getRTCStats(this.impl).then(function (statistic) {
                if (typeof _this3._call !== 'undefined') _this3._call.dispatchEvent({ name: 'RTCStatsReceived', stats: statistic });
            });
        }
    }, {
        ...
        value: function _runReinvite() {
            ...
            if (this.renegotiationInProgress === false) {
                ...
                this.log.trace(JSON.stringify(offerOption));
                this.updateHoldState();
                this.impl.createOffer(offerOption).then(function (sdp) {
                    return _this4.codecRearrange(sdp);
                }).then(function (sdp) {
                    ...
                    tempsdp = SDPMuggle_1.SDPMuggle.fixVideoRecieve(tempsdp, _this4.videoEnabled.receiveVideo);
                    // remove transportCC
                    ...
                    _this4.pendingOffer = sdp;
                    return sdp;
                }).then(function () {
                    var extra = { tracks: _this4.getTrackKind() };
                    VoxSignaling_1.VoxSignaling.get().callRemoteFunction(RemoteFunction_1.RemoteFunction.reInvite, _this4._call.id(), {}, _this4.pendingOffer.sdp, extra);
                }).catch(function (e) {
                    _this4.log.error('Error when renegatiation start ' + e.message);
                });
            } else {
        ...
        value: function _getLocalOfferFF() {
            ...
            this.iceRole = RTCIceRole.controlling;
            return new Promise(function (resolve, reject) {
                var rtcOfferOptions = _this8.getReceiveOptions();
                _this8.impl.createOffer(rtcOfferOptions).then(function (sdp) {
                    var tempsdp = { type: sdp.type, sdp: sdp.sdp };
                    tempsdp = PCFactory_1.PCFactory.get().addBandwidthParams(tempsdp);
                    // remove transportCC
                    if (Client_1.Client.getInstance().config().experiments && Client_1.Client.getInstance().config().experiments.removeTransportCC) {
                ...
                if (_this13.renegotiationInProgress === false) {
                    ...
                    _this13.impl.setLocalDescription(_this13.pendingOffer).then(function () {
                        try {
                            ...
                            _this13.renegotiationInProgress = false;
                            _this13.log.error(JSON.stringify(e));
                            setTimeout(function (_) {
                                return _this13._fixTransreceiver();
                            }, 0);
                            reject(e);
                ...
                if (typeof call !== 'undefined') {
                    ...
                    if (typeof call.rearangeCodecs !== 'undefined') {
                        call.rearangeCodecs(userCodecList, call.settings.incoming).then(function (newCodecList) {
                            ...
                            _this14.log.error(JSON.stringify(e));
                            reject(e);
                        });
                    } else {
                        _this14.log.info('No sdp transformer registered');
                    ...
                    if (_this20.srcRemoteSDP && _this20.srcRemoteSDP.indexOf('VIMS') === -1) {
                        if (_this20.impl && _this20.impl.setConfiguration) {
                            ...
                            if (_this20._pendingOffer) {
                                ...
                                _this20.impl.createOffer().then(function (_) {
 ...
 * @hidden
 */
var IOSCacheManager_1 = __webpack_require__(46);
...
var TransreceiverPC = function (_PeerConnection_1$Pee) {
    ...
    _createClass(TransreceiverPC, [{
        ...
        value: function _fixFFSoundBug() {
            ...
            if (BrowserSpecific_1.default.getWSVendor() === 'firefox' && PCFactory_1.PCFactory.hasTransceivers) {
                setTimeout(function () {
                    if (_this18.impl.getSenders) {
                        var senders = _this18.impl.getSenders();
                        senders.forEach(function (sender) {
                            if (sender.replaceTrack) {
                                var track = sender.track;
                                sender.replaceTrack(track);
        ...
        value: function setConfiguration(config) {
            ...
            if (this.impl) {
                setTimeout(function () {
                    if (_this19.srcRemoteSDP && _this19.srcRemoteSDP.indexOf('VIMS') === -1) {
                        if (_this19.impl && _this19.impl.setConfiguration) {
                            _this19.impl.setConfiguration(config);
                            _this19.renegotiationInProgress = false;
                            _this19._runReinvite(true);
                        } else {
                            if (_this19._pendingOffer) {
                                var tracks = [];
                                _this19.impl.getTransceivers().map(function (tr) {
                                    if (tr.sender.track) tracks.push(tr.sender.track);
                                });
                                _this19._createImpl(config);
                                tracks.forEach(function (track) {
                                    _this19.impl.addTrack(track, new MediaStream([track]));
                                });
                                _this19.impl.createOffer().then(function (_) {
                                    _this19._needIceRestart = true;
                                    return _this19.impl.setLocalDescription(_this19._pendingOffer);
                                }).then(function () {
                                    _this19._pendingOffer = void 0;
                                }).catch(function (ev) {
                                    console.error(ev);
                                });
                            }
...
__decorate([Logger_1.LogManager.d_trace(Logger_1.LogCategory.RTC)], TransreceiverPC.prototype, "_processRemoteOffer", null);
...
var adapterFactory = __webpack_require__(60);
...
module.exports = function(dependencies, opts) {
  ...
  // Browser shims.
  var chromeShim = __webpack_require__(61) || null;
  var edgeShim = __webpack_require__(63) || null;
  var firefoxShim = __webpack_require__(66) || null;
  var safariShim = __webpack_require__(68) || null;
  var commonShim = __webpack_require__(69) || null;
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(62)
};
...
var utils = __webpack_require__(9);
var shimRTCPeerConnection = __webpack_require__(64);
